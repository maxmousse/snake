...
const INITIAL_SNAKE_SIZE: u16 = 3;
...
impl Game {
    ...
    pub fn run(&mut self) {
        ...
        while !done {
            ...
            // TODO: check this part as it's not clear
            // Check for commands during the interval and apply them
            ...
            // Check end-game conditions and quit, or continue the game
